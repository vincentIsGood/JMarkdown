...
public class MarkdownParserMainTest {
    ...
    void testParse_table() {
        ...
        *asd*""");
        ...
        assertEquals("p", result.get(3).type);
        assertEquals("asd", ((TextNode)result.get(3).value).groups.get(0).value);
        assertTrue(((TextNode)result.get(3).value).groups.get(0).isEmphasis);
    }
}
